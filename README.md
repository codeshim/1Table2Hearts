...
3. Photon2와 Voice for Photon2를 이용한 네트워크 구현과 음성채팅
...
4. C# 언어와 Unity Editor로 사용자가 체험하게 되는 전반적인 경험의 연출과 조작 구현
...
5. Arduino Physical Computing을 통한 심박센서 데이터 수집 설계와 납땜
